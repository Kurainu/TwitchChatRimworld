...
/// <summary>Central store of the tunable look-and-feel values for the speech bubbles.</summary>
internal static class Theme
{
	private static readonly GUIStyle BaseFontStyle = new GUIStyle(Text.fontStyles[2])
	{
	...
	public static float FadeLength { get; set; } = 5f;
	...
	public static GUIStyle GetFont(float scale)
	{
		return new GUIStyle(BaseFontStyle)
		{
			fontSize = Mathf.CeilToInt(FontSize * scale)
		};
	}

	public static Rot4 GetOffsetDirection()
	{
		return new Rot4(OffsetDirection);
	}
}
